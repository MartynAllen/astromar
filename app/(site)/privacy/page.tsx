...
export default function PrivacyPage() {
  return (
    <div className="mx-auto max-w-2xl px-6 py-14">
      ...
      <h1 className="font-display text-4xl italic text-star-100">Privacy</h1>
      <p className="mt-2 text-star-500">Kept short, because there isn&apos;t much to say.</p>

      <div className="mt-8 space-y-6 text-star-300">
        <section>
          <h2 className="font-display text-xl italic text-star-100">Analytics</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="font-display text-xl italic text-star-100">Affiliate links</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="font-display text-xl italic text-star-100">Contact</h2>
          <p className="mt-2">
