...
const SECTION_TEASERS = [
  {
    ...
    border: "hover:border-nebula-rose-400",
  ...
  },
  {
    ...
    border: "hover:border-nebula-amber-400",
    heading: "group-hover:text-nebula-amber-400",
  },
  {
    href: "/calendar",
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            {SECTION_TEASERS.map((teaser) => (
              <Link
                key={teaser.href}
                href={teaser.href}
                className={`group rounded-lg border border-void-700 bg-void-900 p-6 transition-colors ${teaser.border}`}
              >
                <h3
                  className={`font-display text-lg font-semibold text-star-100 ${teaser.heading}`}
                >
                  {teaser.title}
                </h3>
