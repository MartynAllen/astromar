...
export default function MoonPhaseWidget() {
  ...
  return (
    <div className="flex items-center gap-5 rounded-lg border border-void-700 bg-void-900 p-5">
      ...
      <div>
        ...
        <p className="mt-1 font-display text-lg font-medium text-star-100">{phaseName}</p>
